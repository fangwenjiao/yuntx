    ...
    static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        void createTableForISession(SQLiteDatabase db) {
            ...
            String sql = "CREATE TABLE IF NOT EXISTS "
                    ...
                    + IThreadColumn.CONTACT_ID + " TEXT NOT NULL, "
                    + IThreadColumn.UNREAD_COUNT + "  INTEGER, "
        ...
        void createTriggerForIMessage(SQLiteDatabase db) {
            ...
            sql = "CREATE TRIGGER IF NOT EXISTS im_update_thread_on_delete AFTER DELETE ON " + TABLES_NAME_IM_MESSAGE +" "
                    ...
                    + "UPDATE " + TABLES_NAME_IM_SESSION + " SET " + IThreadColumn.DATE + " =    (SELECT " + IMessageColumn.RECEIVE_DATE + " FROM (SELECT " + IMessageColumn.RECEIVE_DATE + ", " + IMessageColumn.OWN_THREAD_ID + " FROM " + TABLES_NAME_IM_MESSAGE + ")    WHERE " + IMessageColumn.OWN_THREAD_ID + " = old." + IMessageColumn.OWN_THREAD_ID + " ORDER BY " + IMessageColumn.RECEIVE_DATE + " DESC LIMIT 1)   WHERE " + TABLES_NAME_IM_SESSION + ".id = old." + IMessageColumn.OWN_THREAD_ID + ";   "
            ...
            sql = "CREATE TRIGGER IF NOT EXISTS im_update_thread_on_insert AFTER INSERT ON " + TABLES_NAME_IM_MESSAGE +" "
                    + "BEGIN  "
                    + "UPDATE " + TABLES_NAME_IM_SESSION + " SET "
                    + IThreadColumn.DATE + " = new." + IMessageColumn.RECEIVE_DATE + ","
                    ...
                    + "UPDATE " + TABLES_NAME_IM_SESSION + " SET " + IThreadColumn.UNREAD_COUNT + " =(SELECT COUNT(*) FROM " + TABLES_NAME_IM_MESSAGE+ " WHERE " + IMessageColumn.READ_STATUS+ " = 0 AND " + IMessageColumn.BOX_TYPE + " = 1 AND " + IMessageColumn.OWN_THREAD_ID + " = new." + IMessageColumn.OWN_THREAD_ID + ")  WHERE " + TABLES_NAME_IM_SESSION + ".id = new." + IMessageColumn.OWN_THREAD_ID + ";  "
                    + "END;";
            LogUtil.d(LogUtil.getLogUtilsTag(AbstractSQLManager.class), sql);
            db.execSQL(sql);
